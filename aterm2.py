    ...
    async with AsyncExitStack() as exit_stack:
        try:
            mcp_start = await asyncio.gather(*[
                mcp_session_start(prefix + "__", mcp_config, exit_stack)
            ...
            messages = []
            query = "Please ping the echo tool with the message I'm a teapot and walk me through the process and explain the result ;) Make sure the message is echoed back to us."
            print(query)
